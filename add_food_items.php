...
<html>
  ...
  <head>
    <title> Manager Login | ASPRESSO </title>
  </head>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="file" class="form-control" id="img_file" name="img_file" placeholder="Your Food Image Path [images/<filename>.<extention>]" required="">
          </div>
